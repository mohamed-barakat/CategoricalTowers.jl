...
uninstall:
	julia -e 'using Pkg; Pkg.rm("ToolsForCategoricalTowers");'
...
git-commit:
	...
	echo -e "\033[32mCommitting changes in \"ToolsForCategoricalTowers\"\033[0m"; \
	git add .; \
	git commit \
		...
		echo -e "\033[33mNo changes in \"ToolsForCategoricalTowers\" to commit or no version bump detected.\033[0m"; \
	fi

...
@InstallMethod( QuotientCategory,
  ...
  function ( A, relations )
    ...
    elseif (CanCompute( H, "IsLiftable" ))
    ...
    name = @Concatenation( "QuotientCategory( ", Name( A ), ", 2-sided ideal generated by ", StringGAP( Length( relations ) ), " morphisms )" );

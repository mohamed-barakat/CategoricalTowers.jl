                            ...
                            return UnionOfRowsListList( hoisted_9_1[i_3], List( deduped_4_1, function ( s_4 )
                                      ...
                                      if (deduped_7_4 == 0 || hoisted_1_3)
                                          ...
                                          return UnionOfColumnsListList( deduped_7_4, List( deduped_7_1, function ( t_5 )
                                                    ...
                                                    if (deduped_5_5 == 0 || deduped_6_5 == 0)
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    if (deduped_6_1 != Length( ObjectList( Source( arg3_1 ) ) ))
        return false;
    elseif (deduped_7_1 != Length( ObjectList( Range( arg3_1 ) ) ))
        return false;
    else
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    if (deduped_5_1 != Length( deduped_7_1 ))
        return false;
    else
...
function ( cat_1, alpha_1 )
    ...
    if (!(IsList( deduped_16_1 ) && Length( deduped_16_1 ) == deduped_12_1))
        return false;
    elseif (@not ForAll( deduped_11_1, function ( i_2 )
                 return (hoisted_1_1[i_2] && hoisted_2_1[i_2] == deduped_13_1);
             end ))
        return false;
    elseif (@not ForAll( deduped_11_1, function ( i_2 )
                 local hoisted_1_2, hoisted_2_2, hoisted_3_2, hoisted_4_2;
                 ...
                 return ForAll( hoisted_10_1, function ( j_3 )
                         ...
                         return (hoisted_1_2[j_3] == hoisted_6_1[deduped_1_3][deduped_2_3] && deduped_1_3 == hoisted_4_2 && deduped_2_3 == hoisted_9_1[j_3]);
                     end );
             end ))
        return false;
    else
...
function ( cat_1, arg2_1 )
    ...
    if (@not IsList( deduped_1_1 ))
        return false;
    elseif (@not ForAll( deduped_1_1, function ( obj_2 )
                 return true;
             end ))
        return false;
    else
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_32_1, deduped_33_1, MorphismMatrix, List( (1):(Length( deduped_29_1 )), function ( i_2 )
              ...
              return List( hoisted_28_1, function ( j_3 )
                      return CreateCapCategoryMorphismWithAttributes( deduped_35_1, hoisted_7_2, deduped_30_1[j_3], CoefficientsList, Iterated( List( hoisted_24_1, function ( k_4 )
                                  ...
                                  if (deduped_19_4 == 0 || deduped_25_4 == 0 || (deduped_20_4 == 0 || deduped_23_4 == 0))

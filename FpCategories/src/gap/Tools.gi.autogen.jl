...
@InstallMethod( YonedaEmbeddingData,
        [ IsCapCategory && HasDefiningTripleOfUnderlyingQuiver && HasRangeCategoryOfHomomorphismStructure ],
...
@InstallMethod( YonedaEmbeddingData,
  ...
  function ( C )
    ...
    if (!( HasDefiningTripleOfUnderlyingQuiver( C ) && HasRangeCategoryOfHomomorphismStructure( C ) ))
        TryNextMethod( );
    end;

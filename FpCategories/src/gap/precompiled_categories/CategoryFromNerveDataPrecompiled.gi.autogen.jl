...
function ( cat_1, alpha_1 )
    ...
    return CAP_JIT_EXPR_CASE_WRAPPER( function (  )
                  if (@not ForAll( deduped_4_1, function ( a_3 )
                      ...
                      return false;
                  elseif (deduped_2_1 != Length( deduped_4_1 ))
                      return false;
                  elseif (@not ForAll( deduped_4_1, function ( a_3 )
                  ...
                  return;
              end )(  ) && deduped_2_1 == 1 && Length( NerveData( cat_1 )[1][2] ) == deduped_3_1;
end
########
...
function ( cat_1, arg2_1 )
    ...
    return CAP_JIT_EXPR_CASE_WRAPPER( function (  )
                  ...
                  return;
              end )(  ) && deduped_2_1 == 1 && Length( NerveData( cat_1 )[1][1] ) == deduped_3_1;
end
########

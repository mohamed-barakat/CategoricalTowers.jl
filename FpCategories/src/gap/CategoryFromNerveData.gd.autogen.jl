...
@DeclareFilter( "IsCategoryFromNerveData",
        IsCapCategory );

#! @Description
#!  The &GAP; category of objects in a category from nerve data.
@DeclareFilter( "IsObjectInCategoryFromNerveData", IsCapCategoryObject );

#! @Description
#!  The &GAP; category of morphisms in a category from nerve data.
@DeclareFilter( "IsMorphismInCategoryFromNerveData", IsCapCategoryMorphism );
...
CapJitAddTypeSignature( "NerveData", [ IsCapCategory ],
  function ( input_types )
    ...
    @Assert( 0, HasIsFiniteCategory( input_types[1].category ) && IsFiniteCategory( input_types[1].category ) );
